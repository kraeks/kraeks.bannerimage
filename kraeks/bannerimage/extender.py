...
extension_fields = [
               ...
               CustomLinesField('viewlet',
               schemata='Medien',
               widget = SelectionWidget(
                          label = _(u"Stelle der Anzeige"),
                          description = _(u"Bitte waehlen Sie aus an welcher Stelle der Seite das Banner angezeigt werden soll."),
                          format = "radio",
                          ),
               vocabulary = [(u'header',u'Unter Navigationstabs'),(u'abovetitle',u'Kopf des Dokuments')],
                 ),
